                    ...
                    <tbody class="divide-y divide-gray-700/50">
                        @foreach($lessonMaster as $lesson)
                            <tr class="hover:bg-white/10 transition-colors duration-200">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{ $lesson['masterBase']->master_name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{ $lesson['lessonName']->lesten_name }}</td>
